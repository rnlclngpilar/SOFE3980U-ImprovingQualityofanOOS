...
void seticon()
{
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pack.ChitChatApp2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
          pack.ChitChatApp2 root = new pack.ChitChatApp2();  //initializing the main gui
